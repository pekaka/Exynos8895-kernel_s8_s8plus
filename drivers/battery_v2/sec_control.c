...
struct charge_control charge_controls[] = {
	...
	charge("hv_12v", POWER_SUPPLY_TYPE_HV_MAINS_12V),
	charge("hv_qc20", POWER_SUPPLY_TYPE_HV_QC20),
	charge("hv_qc30", POWER_SUPPLY_TYPE_HV_QC30),
	...
	charge("wpc"	, POWER_SUPPLY_TYPE_WIRELESS_PACK),
	charge("wptc"	, POWER_SUPPLY_TYPE_WIRELESS_PACK_TA),
	charge("wsc"	, POWER_SUPPLY_TYPE_WIRELESS_STAND),
	charge("whvsc"	, POWER_SUPPLY_TYPE_WIRELESS_HV_STAND),
